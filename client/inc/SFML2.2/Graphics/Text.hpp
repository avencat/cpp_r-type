...
#include <SFML2.2/Graphics/Drawable.hpp>
#include <SFML2.2/Graphics/Transformable.hpp>
#include <SFML2.2/Graphics/Font.hpp>
#include <SFML2.2/Graphics/Rect.hpp>
#include <SFML2.2/Graphics/VertexArray.hpp>
